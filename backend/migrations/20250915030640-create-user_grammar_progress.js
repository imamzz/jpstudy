...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.createTable("user_grammar_progress", {
      id: { type: Sequelize.INTEGER, autoIncrement: true, primaryKey: true },
      user_id: { type: Sequelize.INTEGER, allowNull: false },
      grammar_id: { type: Sequelize.INTEGER, allowNull: false },
  ...
  async down(queryInterface) {
    await queryInterface.dropTable("user_grammar_progress");
  },
};
